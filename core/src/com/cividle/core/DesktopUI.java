...
import com.cividle.util.Devmode;
import com.cividle.util.Saver;
import com.cividle.util.Shorthand;
...
public class DesktopUI extends javax.swing.JFrame {
     ...
     * @param devmode
     */
    public DesktopUI(Game game, boolean devmode) {
        try {
        ...
        initButtons();
        initConsoleField();
        TradeEventPanel.setVisible(false);
    ...
    public void SetTradeEventDialog(String s, boolean visible) {
        TradeEventLabel.setText(s);
        TradeEventPanel.setVisible(visible);
    }
...
//        Console.setOut(ConsoleOutputWindow);
    ...
    private void displayResources(ResourceManager rm) {
        FoodAmountLabel.setText(rm.food.displayAmount() + rm.food.displayMaxAmount() + rm.DispFPS(game.pm));
        WoodAmountLabel.setText(rm.wood.displayAmount() + rm.wood.displayMaxAmount() + rm.DispWPS(game.pm));
        StoneAmountLabel.setText(rm.stone.displayAmount() + rm.stone.displayMaxAmount() + rm.DispSPS(game.pm));
    ...
    private void initComponents() {
        ...
        TradeEventPanel = new javax.swing.JPanel();
        TradeEventLabel = new javax.swing.JLabel();
        TradeEventButton = new javax.swing.JButton();
        ...
        TradeEventLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        TradeEventLabel.setText("Trade Event Label");

        TradeEventButton.setText("jButton1");
        TradeEventButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TradeEventButtonActionPerformed(evt);
            }
        });

        javax.swing.GroupLayout TradeEventPanelLayout = new javax.swing.GroupLayout(TradeEventPanel);
        TradeEventPanel.setLayout(TradeEventPanelLayout);
        TradeEventPanelLayout.setHorizontalGroup(
            TradeEventPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(TradeEventPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(TradeEventLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(TradeEventPanelLayout.createSequentialGroup()
                .addGap(44, 44, 44)
                .addComponent(TradeEventButton)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        TradeEventPanelLayout.setVerticalGroup(
            TradeEventPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(TradeEventPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(TradeEventLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(TradeEventButton)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
                    ...
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
                                ...
                                .addGap(86, 86, 86)
                                .addComponent(TradeEventPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())))
        );
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(TradeEventPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        game = CivClicker.Restart();
    ...
    private void TradeEventButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TradeEventButtonActionPerformed

    }//GEN-LAST:event_TradeEventButtonActionPerformed
    ...
    private javax.swing.JButton TradeEventButton;
    private javax.swing.JLabel TradeEventLabel;
    private javax.swing.JPanel TradeEventPanel;
